...
class HirePostTabView extends StatefulWidget {
  @override
  _HirePostTabViewState createState() => _HirePostTabViewState();
}

class _HirePostTabViewState extends State<HirePostTabView> {
